...
var require_addon_attach = __commonJS({
  "node_modules/@xterm/addon-attach/lib/addon-attach.js"(exports, module) {
    !function(e, t) {
      ...
      return (() => {
        ...
        Object.defineProperty(t, "__esModule", { value: true }), t.AttachAddon = void 0, t.AttachAddon = class {
          ...
          dispose() {
            for (const e2 of this._disposables) e2.dispose();
          }
          _sendData(e2) {
          ...
          _sendBinary(e2) {
            ...
            for (let s2 = 0; s2 < e2.length; ++s2) t2[s2] = 255 & e2.charCodeAt(s2);
...
export default require_addon_attach();
