...
WARNING: This link could potentially be dangerous`)) {
        ...
        Object.defineProperty(t2, "__esModule", { value: true }), t2.computeNextVariantOffset = t2.createRenderDimensions = t2.treatGlyphAsBackgroundColor = t2.isRestrictedPowerlineGlyph = t2.isPowerlineGlyph = t2.throwIfFalsy = void 0, t2.throwIfFalsy = function(e3) {
        ...
        t2.NULL_COLOR = { css: "#00000000", rgba: 0 }, function(e3) {
          ...
          e3.blend = function(e4, t4) {
            ...
            if (s3) return h.toColor(s3 >> 24 & 255, s3 >> 16 & 255, s3 >> 8 & 255);
          ...
          e3.toColor = function(e4) {
            if (e4.match(/#[\da-f]{3,8}/i)) switch (e4.length) {
              case 4:
                return r = parseInt(e4.slice(1, 2).repeat(2), 16), n = parseInt(e4.slice(2, 3).repeat(2), 16), o = parseInt(e4.slice(3, 4).repeat(2), 16), h.toColor(r, n, o);
              case 5:
                return r = parseInt(e4.slice(1, 2).repeat(2), 16), n = parseInt(e4.slice(2, 3).repeat(2), 16), o = parseInt(e4.slice(3, 4).repeat(2), 16), a = parseInt(e4.slice(4, 5).repeat(2), 16), h.toColor(r, n, o, a);
              case 7:
            ...
            if (s3) return r = parseInt(s3[1]), n = parseInt(s3[2]), o = parseInt(s3[3]), a = Math.round(255 * (void 0 === s3[5] ? 1 : parseFloat(s3[5]))), h.toColor(r, n, o, a);
          ...
          e3.blend = function(e4, t4) {
            if (a = (255 & t4) / 255, 1 === a) return t4;
            const i4 = t4 >> 24 & 255, s3 = t4 >> 16 & 255, c2 = t4 >> 8 & 255, l2 = e4 >> 24 & 255, d2 = e4 >> 16 & 255, _2 = e4 >> 8 & 255;
            return r = l2 + Math.round((i4 - l2) * a), n = d2 + Math.round((s3 - d2) * a), o = _2 + Math.round((c2 - _2) * a), h.toRgba(r, n, o);
